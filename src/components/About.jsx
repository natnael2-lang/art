        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-gray-600 leading-relaxed">
              <p>
                Studies in Design at Addis Ababa University began at The Addis Ababa School of Fine Arts when it was founded in 1957...
              </p>
              <p>
                Since the integration of The School of Fine Arts into Addis Ababa University...
              </p>
              <p>
                The Design Department at ASFAD currently awards a Bachelor of Fine Arts in Design...
              </p>
            </div>

            <div className="mt-12 flex gap-8">
              {/* Your timeline stays the same */}
