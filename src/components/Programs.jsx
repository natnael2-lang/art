...
const programs = [
  {
    ...
    description:
      "Explore textile arts, garment construction, and contemporary fashion trends while honoring Ethiopian heritage and craftsmanship.",
    image: fashionImage,
    duration: "4 Years",
  ...
  },
  {
    ...
    description:
      "Learn to create functional, aesthetically pleasing products that solve real-world problems through innovative design thinking.",
  ...
  },
  {
    ...
    description:
      "Master visual communications, branding, and digital design to create compelling visual narratives for the modern world.",
    image: graphicImage,
    duration: "4 Years",
    degree: "BFA in Design",
  },
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {programs.map((program, index) => (
            <motion.article
              ...
              className="group bg-card border border-none rounded-2xl overflow-hidden shadow-xl hover:shadow-elevated hover:-translate-y-1 transition-all duration-500 cursor-pointer"
            >
              {/* Image */}
              ...
              <div className="p-6">
                ...
                <button className="text-primary flex justify-between items-center px-3 py-2">
                  Learn More
